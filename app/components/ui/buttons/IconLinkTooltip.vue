...
<template>
  ...
  >
    <Icon
        :name="oneLink.icon"
        size="56"
        class="text-black dark:text-white hover:text-iris-500 hover:dark:text-iris-400 hover:scale-105 active:scale-98 transition-all duration-200"
