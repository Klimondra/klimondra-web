...
<Section class="h-screen mt-6 py-20">
    ...
    >
        <div class="absolute top-0 left-0 w-full h-full bg-linear-to-b from-transparent via-transparent to-azure-800 blur-2xl -z-10"></div>
        <div class="flex flex-col gap-3 z-0">
            <h2 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white text-center">Dělám weby, které fungují</h2>
            <p class="text-base sm:text-lg md:text-xl lg:text-2xl font-light text-neutral-100 tracking-wide text-center">Profesionální weby, které vás odlišují a přinášejí výsledky.</p>
        </div>
        ...
        <div bind:this={photosContainer} class="absolute -bottom-8 w-full h-36 hidden md:flex items-center justify-center gap-8">
