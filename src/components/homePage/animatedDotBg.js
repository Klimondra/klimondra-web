...
const AnimatedDotBg = () => {
    const [dotPos1, setDotPos1] = useState({ x: Math.random() * window.innerWidth, y: Math.random() * window.innerHeight });
    const [dotPos2, setDotPos2] = useState({ x: Math.random() * window.innerWidth, y: Math.random() * window.innerHeight });
